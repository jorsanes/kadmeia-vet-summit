...
const Cases = () => {
  ...
  const seoTitle = locale === 'es' 
    ? 'Casos de Éxito - KADMEIA | Transformación Veterinaria' 
    : 'Success Cases - KADMEIA | Veterinary Transformation';
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            <h1 className="font-display text-4xl font-semibold tracking-tight text-foreground sm:text-5xl mb-6">
              {locale === 'es' ? 'Casos de éxito' : 'Success Cases'}
            </h1>
            <p className="text-xl text-muted-foreground">
              {locale === 'es' 
                ...
                : 'Real projects with measurable results. Discover how we have transformed veterinary businesses with technology and strategy.'}
            </p>
          </motion.div>
                  ...
                  <Card className="card-premium h-full">
                    <CardHeader>
                      ...
                      <p className="text-muted-foreground font-medium">
                        {locale === 'es' ? 'Cliente' : 'Client'}: {caseItem.client}
                      </p>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card className="card-premium">
                    <CardHeader>
                      <CardTitle className="text-lg flex items-center gap-2 text-foreground">
                        ...
                        {locale === 'es' ? 'Resultados obtenidos' : 'Results achieved'}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
              ...
              <CardContent className="p-12">
                ...
                <h3 className="font-display text-2xl font-semibold text-foreground mb-4">
                  {locale === 'es' 
                    ...
                    : 'Will your project be the next success case?'}
                </h3>
                <p className="text-muted-foreground mb-8">
                  {locale === 'es' 
                    ...
                    : 'Every case starts with a conversation. Let\'s talk about your challenges and design a solution that generates measurable results.'}
                </p>
                <Button asChild size="lg" className="btn-primary">
                  <Link to={locale === 'en' ? '/en/contact' : '/contacto'} className="gap-2">
                    {locale === 'es' ? 'Discutir mi proyecto' : 'Discuss my project'}
